...
namespace parcial_2_de_frutas_version_2
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        {
            MessageBox.Show("Friz, Tomás Agustin 2ºA");
        }
        ...
        private static string ObtenerListadoFrutas()
        {
            ...
            SqlConnection conexion = new SqlConnection(parcial_2_de_frutas_version_2.Properties.Settings.Default.conexion);
